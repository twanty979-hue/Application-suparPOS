    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: const [
            Text('รายการสินค้าคงเหลือ', style: TextStyle(fontWeight: FontWeight.w900, fontSize: 18)),
            Text('อัปเดตแบบ Real-time', style: TextStyle(fontSize: 11, color: Color(0xFF64748B), fontWeight: FontWeight.w600)),
          ],
        ),
      ),
      body: Column(
                  ...
                  children: [
                            ...
                            child: Column(
                              ...
                              children: [
                                const FittedBox(
                                  ...
                                  child: Text('พร้อมขาย (ชิ้น)', style: TextStyle(color: Colors.white70, fontSize: 11, fontWeight: FontWeight.bold)),
                                ),
                                const SizedBox(height: 4),
                                FittedBox(
                                  fit: BoxFit.scaleDown,
                                  child: Text(valueFormat.format(totalGoodStock), style: const TextStyle(color: Colors.white, fontSize: 24, fontWeight: FontWeight.w900)),
                                ),
                              ],
                            ),
                          ),
                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                const FittedBox(
                                  fit: BoxFit.scaleDown,
                                  child: Text('ทั้งหมด (SKU)', style: TextStyle(color: Color(0xFF94A3B8), fontSize: 11, fontWeight: FontWeight.bold)),
                                ),
                                const SizedBox(height: 4),
                                FittedBox(
                                  fit: BoxFit.scaleDown,
                                  child: Text(valueFormat.format(totalSKU), style: const TextStyle(color: Color(0xFF1E293B), fontSize: 24, fontWeight: FontWeight.w900)),
                                ),
                              ],
                            ),
                          ),
                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                const FittedBox(
                                  fit: BoxFit.scaleDown,
                                  child: Text('มูลค่ารวม (บาท)', style: TextStyle(color: Color(0xFF94A3B8), fontSize: 11, fontWeight: FontWeight.bold)),
                                ),
                                const SizedBox(height: 4),
                                FittedBox(
                                  fit: BoxFit.scaleDown,
                      ...
                      child: Row(
                        children: [
                          const Padding(
                            ...
                            child: Icon(Icons.search_rounded, color: Color(0xFF94A3B8)),
                          ),
                          Expanded(
                            child: TextField(
                    ...
                    if (_isLoading)
                      ...
                      Container(
                        ...
                        child: const Center(
                          child: Text('ไม่พบรายการสินค้า', style: TextStyle(fontWeight: FontWeight.bold, color: Color(0xFF64748B))),
                        ),
                      )
                    else
                      ListView.separated(
                            ...
                            child: Row(
                              children: [
                                Container(
                                  ...
                                  child: imgUrl != null
                                      ? Image.network(imgUrl, fit: BoxFit.cover, errorBuilder: (c, o, s) => const Icon(Icons.inventory_2_outlined, color: Color(0xFFCBD5E1)))
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      Row(
                                        children: [
                                          Container(
                                            ...
                                            child: Text(statusText, style: TextStyle(color: textColor, fontSize: 9, fontWeight: FontWeight.w900)),
                                          ),
                                          const SizedBox(width: 8),
                                          Expanded(
                                            child: Text(
                                      ...
                                      Text(item['name'] ?? '', style: const TextStyle(fontWeight: FontWeight.w900, fontSize: 14, color: Color(0xFF1E293B)), maxLines: 1, overflow: TextOverflow.ellipsis),
                                      const SizedBox(height: 2),
                                      Text(item['barcode'] ?? item['sku'] ?? 'ไม่มีบาร์โค้ด', style: const TextStyle(fontSize: 11, color: Color(0xFF94A3B8), fontFamily: 'monospace', fontWeight: FontWeight.w600)),
                                    ],
                                  ),
                                ),
                                const SizedBox(width: 8),
                                Column(
                                  ...
                                  children: [
                                    const Text('คงเหลือ', style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold, color: Color(0xFF94A3B8))),
                                    const SizedBox(height: 2),
                                    Text(
                                      ...
                                      style: TextStyle(
                                        ...
                                        color: qty <= 0 ? const Color(0xFFEF4444) : const Color(0xFF1E293B),
                                      ),
                                    ),
                                  ],
                                ),
